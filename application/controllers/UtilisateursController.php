	...
	public function parcoursformateurAction(){
		...
		if(!empty($this->user->is_logged) && $this->user->is_logged === true){
            ...
            if($utilisateur->getPresentationAccepte() != 1)
                $this->_redirector->goToUrl('/presentation-detaillee');
